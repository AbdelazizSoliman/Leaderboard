...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _scores_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scores.js */ \"./src/scores.js\");\n\n\n\nconst gameId = 'ABC123';\n\nconst clearInputs = () => {\n  document.getElementById('name').value = '';\n  document.getElementById('score').value = '';\n};\n\ndocument.getElementById('refresh-button').addEventListener('click', () => {\n  (0,_scores_js__WEBPACK_IMPORTED_MODULE_1__.refreshScores)(gameId);\n});\n\ndocument\n  .getElementById('add-form')\n  .addEventListener('submit', async (event) => {\n    event.preventDefault();\n    const user = document.getElementById('name').value;\n    const score = document.getElementById('score').value;\n    await (0,_scores_js__WEBPACK_IMPORTED_MODULE_1__.submitScore)(gameId, user, score);\n    await (0,_scores_js__WEBPACK_IMPORTED_MODULE_1__.refreshScores)(gameId);\n    clearInputs();\n  });\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
